...
import {
  UserGroupIcon, DocumentTextIcon, BanknotesIcon, ReceiptPercentIcon, ScaleIcon, CubeIcon, HandThumbUpIcon
...
const statsData: StatCardProps[] = [
  { title: 'Total Customers', value: '1,245 +', Icon: UserGroupIcon, iconBgColor: 'bg-blue-500/20', iconColor: 'text-blue-300' },
  { title: 'Total Loans', value: '832 +', Icon: DocumentTextIcon, iconBgColor: 'bg-green-500/20', iconColor: 'text-green-300' },
  { title: 'Total Loan Amount', value: '₹50 L', Icon: BanknotesIcon, iconBgColor: 'bg-indigo-500/20', iconColor: 'text-indigo-300' },
  { title: 'Total Interest', value: '₹38 L', Icon: ReceiptPercentIcon, iconBgColor: 'bg-amber-500/20', iconColor: 'text-amber-300' },
  { title: 'In Hand (Amount)', value: '₹45 L', Icon: HandThumbUpIcon, iconBgColor: 'bg-pink-500/20', iconColor: 'text-pink-300' },
  { title: 'Gold Rate (24K)', value: '₹7,150/g', Icon: ScaleIcon, iconBgColor: 'bg-yellow-500/20', iconColor: 'text-yellow-300' },
];
const loanData = [
        ...
        <ChartCard title="New Customers / Week">
          <ResponsiveContainer>
            <LineChart data={customerData}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="NewCustomers" stroke="#ff7300" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </ChartCard>
