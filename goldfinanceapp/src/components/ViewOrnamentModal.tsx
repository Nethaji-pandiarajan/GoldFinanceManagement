...
export default function ViewOrnamentModal({ ornament, onClose }: { ornament: any; onClose: () => void }) {
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex justify-center items-center z-50 p-4">
      <div className="bg-[#111315] rounded-lg shadow-xl p-8 w-full max-w-lg">
        <div className="flex justify-between items-start">
            <h2 className="text-2xl font-bold text-[#c69909] mb-6">Ornament Details</h2>
