...
function LoginPage() {
  ...
  // Adjusted icon position slightly for perfect centering with the text
  ...
  return (
    <AuthLayout>
      <div className="w-full max-w-md bg-white/20 backdrop-blur-lg shadow-xl rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Corrected Email/Username Input Structure */}
          <div className="mb-6">
            <label className="block text-white/90 text-sm font-bold mb-2" htmlFor="email">
              Email or Username
            </label>
            <div className="relative"> {/* This new div is the key */}
          ...
          {/* Corrected Password Input Structure */}
          <div className="mb-2">
            <label className="block text-white/90 text-sm font-bold mb-2" htmlFor="password">
              Password
            </label>
            <div className="relative"> {/* This new div is the key */}
          ...
          <div className="text-right mb-6">
            <a className="inline-block align-baseline font-bold text-sm text-blue-300 hover:text-blue-200" href="#">
              Forgot password?
            </a>
          </div>
          <div className="mb-4">
